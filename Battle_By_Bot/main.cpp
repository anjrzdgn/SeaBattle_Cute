...
static GamePage* page = new GamePage();

void setboard(int xp, int yp, QChar status, GamePage* page)
{
    int yPos;
    int xPos;
...
void simpleAttack(QChar _table[10][10])
{
    ...
    while (countshipperson < 10)
    {
        ...
        else if (_table[randX][randY] == 'E')
        {
            ...
            setboard(randX, randY, 'W', GamePage::page);
...
int main(int argc, char *argv[]) {
    ...
    // GamePage gamePage;
    GamePage::page->setGeometry(0,0,1536,864);
